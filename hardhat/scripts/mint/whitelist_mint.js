...
const srcAddr = "0xBdd37ff0E89E61A8c91f75554A02c80B96374680";

let whitelistAddresses = [
    "0x5DE4Fc4548ba286EB29173630618D4Ef5E489Bd6",
...
let owner, leafNodes, merkleTree, clamingHashedAddress, hexProof;
...
async function getMerkleTree() {
    ...
    clamingHashedAddress = keccak256(owner.address)
...
async function mint() {
    ...
    let tx = await (await contract.whitelistMint(hexProof)).wait()
    console.log(`✅ [${hre.network.name}] whitelistMint(${hexProof})`)
